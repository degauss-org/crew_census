...
d_2000 <- read_csv('crew_tract_data/crew_tract_2000.csv')
...
# s_1980 <- read_sf('tract_shps/US_tract_1980_conflated.shp')
s_1990 <- read_sf('tract_shps/us_tract_1990_conflated.shp')
s_2000 <- read_sf('tract_shps/US_tract_2000_conflated.shp')
...
s_2010 <- read_sf('tract_shps/us_tract_2010.shp')
